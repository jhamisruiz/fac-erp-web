...
export declare class PanelMenu implements AfterContentInit {
    ...
    getPanelId(index: any): string;
    getPanelKey(index: any): string;
    getHeaderId(index: any): string;
    getContentId(index: any): string;
